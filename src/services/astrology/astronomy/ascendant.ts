 ...
 * ε=0: with no axial tilt, the rising point on the celestial equator is
 * exactly 90° behind the meridian in the direction of sky rotation, i.e.
 * Asc = RAMC - 90°. This module's formula reduces to exactly that at
 * φ=ε=0 (see ascendant.test.ts) — that's what pins down the sign that
 * distinguishes the Ascendant from the Descendant (they differ by 180°).
 */
